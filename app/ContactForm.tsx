...
export function ContactForm() {
  ...
  return (
    <form ref={formRef} className="contact-form" action={contactFormEndpoint} method="POST" onSubmit={handleSubmit} onKeyDown={handleKeyDown} aria-busy={sending}>
      ...
      <label className="contact-form-message">
        <span>Message</span>
        <textarea name="message" placeholder="Message" rows={7} required disabled={sending} />
      </label>
